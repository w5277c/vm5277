...
;xБ	-аргументы												; - неизвестная длина 1
;2Б	-адрес возврата
;2Б	-регистровая пара Y
;xБ	-локальные переменные=стек фрейм						;- неизвестная длина 2 (этот адрес записан в Y)
...
;-----------------------------------------------------------
	...
	LDD _SPH,Y+0x03											;Восстанавливаем адрес возврата
	LDD _SPL,Y+0x04
	LDD ATOM_L,Y+0x01										;Восстанавливаем Y
	LDD YL,Y+0x02
	MOV YH,ATOM_L
