...
**Можно приступать к первым шагам для знакомства с тулкитом, лучше всего использовать ATmega168p или ATmega328p (как вариант - ARDUION-UNO)

### Следующие шаги
- Тестирование на основе примеров с послледующим багфиксингом и доработкой RTOS
