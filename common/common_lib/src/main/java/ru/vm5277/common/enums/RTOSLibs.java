...
public enum RTOSLibs {
	...
	MATH_SHR8("math/shr8.asm"),
	MATH_SHR16("math/shr16.asm"),
	MATH_SHR32("math/shr32.asm"),
	MATH_SHL8("math/shl8.asm"),
	MATH_SHL16("math/shl16.asm"),
	MATH_SHL32("math/shl32.asm"),
	NEW_ARRAY("j8b/new_array.asm"),
	ARR_CELLADDR("j8b/arr_celladdr.asm"),
	ARRVIEW_CELLADDR("j8b/arrview_celladdr.asm"),
	...
	NEW_THREAD("j8b/new_thread.asm"),
	NEW_CLASS("j8b/new_class.asm");
	
	public static enum CLASS_REFCOUNT_PROCS {
