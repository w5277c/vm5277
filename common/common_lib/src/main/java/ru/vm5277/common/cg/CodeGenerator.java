...
/*		CGBlockScope bScope = (CGBlockScope)scope;
	...
	public CGVarScope enterLocal(VarType type, boolean isConstant, String name) throws CompileException { //TODO сделать индексацию вместо имен
		this.scope = new CGVarScope(scope, genId(), type, (-1 == type.getSize() ? getRefSize() : type.getSize()), isConstant, name);
...
*/		
	...
	public abstract void varStore(CGVarScope lScope, long value) throws CompileException;
...
/*	public long getAcc() {
	...
	public abstract void invokeMethod(CGScope scope, String className, String methodName, VarType type, CGMethodScope mScope) throws CompileException;
	...
	public abstract void eWhile(CGBlockScope condScope, CGBlockScope bodyScope) throws CompileException;
...
//	public abstract void setValueByIndex(Operand op, int size, List<Byte> tempRegs) throws CompileException;
	...
	public abstract void cellsAction(CGScope scope, CGCellsScope cScope, Operator op) throws CompileException;
