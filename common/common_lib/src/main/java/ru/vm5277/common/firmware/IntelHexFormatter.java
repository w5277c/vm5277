...
package ru.vm5277.common.firmware;
...
public class IntelHexFormatter implements FirmwareFormatter, Closeable {
	...
	public IntelHexFormatter(File file) throws Exception {
