...
@Mojo(name = "iflash")
public class J8bIFlashMojo extends J8bMojo {
	@Override
	public void execute() throws MojoExecutionException {
		...
		if("pom".equals(project.getPackaging())) {
			log.warn("J8B iflash goal cannot be executed on parent POM project.");
			log.warn("Please run 'mvn j8b:iflash' from a specific module directory instead.");
			return;
		}
