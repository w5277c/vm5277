...
public class J8bBuildMojo extends J8bMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		if("pom".equals(project.getPackaging())) {
			getLog().warn("J8B build goal cannot be executed on parent POM project.");
			getLog().warn("Please run 'mvn j8b:build' from a specific module directory instead.");
			return;
		}
