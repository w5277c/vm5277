...
public class MyCompletionItem implements CompletionItem {
	private	static	ImageIcon	fieldIcon	= new ImageIcon(ImageUtilities.loadImage("ru/vm5277/lsp/nb/lsp/plugin/list_16.png"));
	private	static	Color		fieldColor	= Color.decode("0x0000B2");
	private			String		text;
	private			int			dotOffset;
	private			int			caretOffset;
	
	public MyCompletionItem(String text, int dotOffset, int caretOffset) {
		this.text = text;
