...
#TODO скопировано из atmega328p.inc - добавить новые фичи

.include "common.asm"

;---DESCRIPTION---------------------------------------------
;Header for ATMega328pb (32KB ROM, 1KB EEPROM, 2KB SRAM, LE)

	.DEVICE ATmega328PB
	.EQU DEVICE_SIGNATURE							= 0x001E9514
	...
	.EQU BOOT_256W_ADDR								= 0x3f00; Начальный адрес полукилобайтного бутлоадера В СЛОВАХ
