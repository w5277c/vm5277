...
Подходит для большинства AVR-чипов, включая ATmega328p, и не требует установки дополнительного ПО на МК.
...
К сожалению, многие из них обладают рядом минусов: работа только под Windows, отсутствие возможности работы в debugWIRE режиме, ограниченное количество поддерживаемых программаторов и МК.*
